...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return {
            ...
            sendSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.sendSequences) ? object.sendSequences.map((e) => exports.PacketSequence.fromJSON(e)) : [],
            recvSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.recvSequences) ? object.recvSequences.map((e) => exports.PacketSequence.fromJSON(e)) : [],
            ackSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.ackSequences) ? object.ackSequences.map((e) => exports.PacketSequence.fromJSON(e)) : [],
            nextChannelSequence: (0, helpers_1.isSet)(object.nextChannelSequence) ? helpers_1.Long.fromValue(object.nextChannelSequence) : helpers_1.Long.UZERO
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.nextChannelSequence !== undefined && (obj.nextChannelSequence = (message.nextChannelSequence || helpers_1.Long.UZERO).toString());
        return obj;
    },
    fromPartial(object) {
