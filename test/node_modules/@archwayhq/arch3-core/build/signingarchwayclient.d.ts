...
import { HttpBatchClientOptions, TendermintClient } from '@cosmjs/tendermint-rpc';
...
export declare class SigningArchwayClient extends SigningCosmWasmClient implements IArchwayQueryClient {
     ...
     * @returns A {@link SigningArchwayClient} connected to the endpoint.
     */
    static createWithSigner(tmClient: TendermintClient, signer: OfflineSigner, options?: SigningArchwayClientOptions): Promise<SigningArchwayClient>;
    /**
